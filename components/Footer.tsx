          ...
          <div>
            <div className="flex items-center gap-3 text-white">
              ...
              <div className="leading-tight">
                <div className="font-display text-lg font-bold">Araújo</div>
                <div className="text-xs uppercase tracking-wider text-brand-400">Dedetizadora</div>
              </div>
            </div>
            ...
            <div className="mt-6 flex gap-3">
              <a
                ...
                aria-label="Facebook"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-ink-800 text-ink-300 transition hover:bg-brand-600 hover:text-white"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="flex h-9 w-9 items-center justify-center rounded-full bg-ink-800 text-ink-300 transition hover:bg-[#25D366] hover:text-white"
              >
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              {featuredServices.map((s) => (
                <li key={s.slug}>
                  <Link href={`/servicos/${s.slug}`} className="hover:text-brand-400">
                    {s.shortTitle}
                  </Link>
                </li>
              ))}
              <li>
                <Link href="/servicos" className="font-medium text-brand-400 hover:text-brand-300">
                  Ver todos →
                </Link>
              </li>
            </ul>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              <li className="flex items-start gap-2">
                ...
                <span>
                  ...
                  {siteConfig.address.neighborhood} • {siteConfig.address.city}/{siteConfig.address.state}<br />
                  CEP {siteConfig.address.zip}
                </span>
              </li>
              <li>
                <a href={phoneLink} className="flex items-center gap-2 hover:text-brand-400">
              ...
              <li>
                <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-brand-400">
              ...
              <li>
                <a href={`mailto:${siteConfig.email}`} className="flex items-center gap-2 hover:text-brand-400 break-all">
