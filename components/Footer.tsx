...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-900 text-ink-300">
      <div className="container py-16">
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              <Image src="/logo-white.png" alt="Araújo Dedetizadora" width={2460} height={671} className="h-12 w-auto" />
              <Image src="/badge-new.png" alt="40 anos de tradição" width={400} height={400} className="h-12 w-12 flex-shrink-0 drop-shadow-md" />
            ...
            <div className="mt-6 flex gap-3">
              <a href={siteConfig.social.facebook} target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-800 text-ink-300 transition hover:bg-yellow-500 hover:text-white">
              ...
              <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-800 text-ink-300 transition hover:bg-yellow-500 hover:text-white">
              ...
              <a href={whatsappLink()} target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="flex h-9 w-9 items-center justify-center rounded-full bg-brand-800 text-ink-300 transition hover:bg-[#25D366] hover:text-white">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              {featuredServices.map((s) => (<li key={s.slug}><Link href={`/servicos/${s.slug}`} className="hover:text-yellow-400">{s.shortTitle}</Link></li>))}
              <li><Link href="/servicos" className="font-medium text-yellow-400 hover:text-yellow-300">Ver todos →</Link></li>
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              <li><a href={phoneLink} className="hover:text-yellow-400">{siteConfig.phoneDisplay}</a></li>
              <li><a href={whatsappLink()} target="_blank" rel="noopener noreferrer" className="hover:text-yellow-400">{siteConfig.whatsappDisplay}</a></li>
