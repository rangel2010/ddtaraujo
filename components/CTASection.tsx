...
export default function CTASection({
  ...
  subtitle = 'Solicite seu orçamento gratuito agora pelo WhatsApp. Atendimento rápido para residências, comércios e condomínios em Londrina e região.',
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center text-white">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <a
              href={phoneLink}
              className="inline-flex items-center justify-center gap-2 rounded-full border-2 border-white bg-transparent px-6 py-3 text-base font-semibold text-white transition hover:bg-white hover:text-brand-700 w-full sm:w-auto"
            >
