...
const GOOGLE_REVIEWS_URL = 'https://www.google.com/search?q=dedetizadora+araujo+londrina#lrd=0x94eb43362244fe61:0xba5a8a2e638cf0f0,1';
const GOOGLE_WRITE_REVIEW_URL = 'https://www.google.com/maps?cid=13428197170801864944';
...
const Check = ({ cls = 'h-5 w-5 text-brand-400' }: { cls?: string }) => (
