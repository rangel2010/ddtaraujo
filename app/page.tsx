...
function ServiceIcon({ name }: { name: string }) {
  // Mapeamento icon key -> arquivo SVG/PNG.
  ...
  const fileMap: Record<string, string> = {
    shield: '/icons/spray-pessoa.svg',          // Dedetização Geral
    rat: '/icons/rato-svg.svg',                // Desratização
    tree: '/icons/inseto.svg',                 // Descupinização
    moon: '/icons/morcego-svg.svg',            // Controle de Morcegos
    bird: '/icons/pombo-v2.svg',               // Manejo de Pombos
    spray: '/icons/limpeza-ambiente.svg',      // Sanitização
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    'water-jet': (<svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 20h18M6 20v-3a2 2 0 012-2h2M8 15V9a3 3 0 016 0M14 9h3l4-4M17 9l4 4M11 20v-4"/></svg>),
    plunger: (<svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 4h8l-1.2 4.5a1 1 0 01-.97.75H10.17a1 1 0 01-.97-.75L8 4zm3.5 5.25V15m0 0c0 2.5-2 3-2 5m2-5c0 2.5 2 3 2 5"/></svg>),
