        ...
        <div className="container">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-3">
            {[
              ...
              { title: 'Responsabilidade ambiental', desc: 'Usamos quantidade mínima de produto para máxima eficácia. Manejo de fauna (morcegos e pombos) sem matar os animais.', icon: 'M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2 2 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064' },
